import{f as y,a as b,r,t as k,o as L,b as v,c as E}from"./assets/localStorage-431a2218.js";import{i as c}from"./assets/vendor-42c9f451.js";let d;const g=document.querySelector(".main-category-title");function p(e){const t=e;console.log(e),y(t).then(o=>{Object.keys(o.data).length!==0?(l.innerHTML="",C(o.data,t)):(l.innerHTML="",c.error({message:"Sorry, there are no books to render",position:"topRight"}))}).catch(o=>{console.log("Error loading data:",o),c.info({message:"Sorry, there are no books to render",position:"topRight",timeout:3e3,progressBar:!1,title:"Error"})})}function C(e,t){l.insertAdjacentHTML("afterbegin",'<ul class="category-books-list"></ul>'),d=document.querySelector(".category-books-list");const o=e.map(a=>`
