import{g as c,d as u,i as m,e as h,h as b,r as s,o as f,t as y}from"./assets/localStorage-c25f72fb.js";import{P as L}from"./assets/vendor-bbb17a86.js";const v=document.querySelector("#shopping-list"),l=document.querySelector(".box-bookslist");p();function p(){c().length?l.classList.add("emptyShoppingList"):l.classList.remove("emptyShoppingList")}function r(t){const e=(t||c()).map(i=>S(i)).join("");v.innerHTML=e,document.querySelector("#shopping-list").addEventListener("click",k)}function k(t){!t.target.hasAttribute("id")!=="icon-deleteBtn"&&(u(t),p(),r())}function S(t){return`<li class="shopping-list-item">
